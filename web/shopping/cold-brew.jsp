...
<div class="main-banner">
    <!-- 메인 이미지 -->
    <img src="./assets/images/cold-brew_main.png" class="img-fluid" alt="메인 이미지">

    <!-- 메인 이미지 위에 배치되는 텍스트 -->
    <div class="banner-text">콜드브루</div>
</div>
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -2rem;">
                <img id="bella-img-3"
                     src="./assets/images/콜드브루/콜드브루 커피 (236ml) 볼드 6캔 선물 세트.jpg"
                     data-default="./assets/images/콜드브루/콜드브루 커피 (236ml) 볼드 6캔 선물 세트.jpg"
                     data-hover="./assets/images/콜드브루/콜드브루.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="콜드브루 커피 (236ml) 볼드 6캔 선물 세트">
                <div class="image-caption" style= "bottom: 80px;">
                    
                    <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">콜드브루 커피 (236ml) 볼드 6캔 선물 세트</h5></div>
                </div>
            </div>
            <div class="caption-status"
            style="background-color: rgba(242, 242, 242, 0.5);
...
<div class="container">
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <div class="image-wrapper" style="position: relative; height: 100%;">
                <img id="bella-img-4"
                     src="./assets/images/콜드브루/콜드브루 보틀.jpg"
                     data-default="./assets/images/콜드브루/콜드브루 보틀.jpg"
                     data-hover="./assets/images/콜드브루/콜드브루 보틀-Hover.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="콜드브루 보틀">
                <div class="image-caption" style= "bottom: 80px;">
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
                <img id="bella-img-5"
                     src="./assets/images/콜드브루/카터 콜드 화이트 16oz 화이트 (473ml).jpg"
                     data-default="./assets/images/콜드브루/카터 콜드 화이트 16oz 화이트 (473ml).jpg"
                     data-hover="./assets/images/콜드브루/카터 콜드 화이트 16oz 화이트 (473ml)-Hover.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="콜드브루/카터 콜드 화이트 16oz 화이트 (473ml)"><br>
                <div class="image-caption" style= "bottom: 80px;">
                    <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">카터 콜드 화이트 16oz 화이트 (473ml)</h5></div>
                </div>
            </div>
            <div class="caption-status"
            style="background-color: rgba(242, 242, 242, 0.5);
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -2rem;">
                <img id="bella-img-6"
                     src="./assets/images/콜드브루/더블월 써모 글라스 세트 (각 350ml).jpg"
                     data-default="./assets/images/콜드브루/더블월 써모 글라스 세트 (각 350ml).jpg"
                     data-hover="./assets/images/콜드브루/더블월 써모 글라스 세트 (각 350ml)-Hover.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="더블월 써모 글라스 세트 (각 350ml)">
                <div class="image-caption" style= "bottom: 80px;">
                    <div class="caption-top" style="margin-top: 8px;"><p class="blend-label" style="font-size: 14px;">유리잔</p></div>
