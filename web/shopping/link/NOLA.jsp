    ...
    <div class="card card-1 position-relative"
      ...
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
            ...
            margin-left: 0;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩17,000</span></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-auto">
    <div class="card card-1 position-relative"
      ...
      <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
        ...
        <div class="image-caption" style= "bottom: 80px;">
          <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">크래프트 인스턴트 커피 블랜드 놀라 3팩 세트</h5></div>
        </div>
      </div>
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
            ...
            justify-content: center;
            margin-left: -0.5rem;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩51,000</span></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-auto">
    <div class="card card-1 position-relative"
      ...
      <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -2rem;">
        ...
        <div class="image-caption" style= "bottom: 80px;">
          <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">크래프트 인스턴트 커피 블랜드 놀라 & 클리어 콜드 텀블러 20oz 세트</h5></div>
        </div>
      </div>
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
            ...
            justify-content: center;
            margin-left: -1rem;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩64,000</span></a>
      </div>
    </div>
  </div>
</div><br>
    ...
    <div class="card card-1 position-relative"
      ...
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
                ...
                justify-content: center;
                margin-left: 0;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩56,000</span></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-auto">
    <div class="card card-1 position-relative"
      ...
      <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
        ...
        <div class="image-caption" style= "bottom: 80px;">
          <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">커뮤터컵 12oz (354ml)</h5></div>
        </div>
      </div>
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
                ...
                justify-content: center;
                margin-left: -0.5rem;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩36,000</span></a>
      </div>
    </div>
  </div>
    ...
    <div class="card card-1 position-relative"
      ...
      <div class="caption-status"
           style="background-color: rgba(242, 242, 242, 0.5);
            ...
            justify-content: center;
            margin-left: -1rem;">
        <a href="" class="add-to-cart"><span style="font-size: 1rem;">카트에 추가 | ₩58,000</span></a>
      </div>
    </div>
  </div>
</div><br>
