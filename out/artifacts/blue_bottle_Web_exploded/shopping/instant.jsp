...
<div class="main-banner">
    <!-- 메인 이미지 -->
    <img src="./assets/images/instant_main.png" class="img-fluid" alt="메인 이미지">

    <!-- 메인 이미지 위에 배치되는 텍스트 -->
    <div class="banner-text">인스턴트 및 인스턴트 세트</div>
</div>
...
<div  class="row justify-content-center" style="justify-content: flex-start;">
    <!-- 1번째 줄 -->     
        ...
        <div class="col-auto">
            <div class="card card-1 position-relative"
                ...
                margin-left: 0;">
                <span style="font-size: 1rem;">품절</span>
            </div>
            </div>
        </div>
            ...
            <div class="card card-1 position-relative"
                ...
                <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
                    <img id="bella-img-2"
                         ...
                         style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                         alt="크래프트 인스턴트 커피 블랜드 놀라"><br>
                    <div class="image-caption" style= "bottom: 80px;">
                        <div class="caption-top" style="margin-top: 8px;"><p class="blend-label" style="font-size: 14px;">브로잉 도구</p></div>
    ...
    <div class="container">
        ...
        <div class="col-auto">
            <div class="card card-1 position-relative"
                ...
                <div class="image-wrapper" style="position: relative; height: 100%;">
                    <img id="bella-img-4"
                         src="./assets/images/인스턴트/블루보틀 온더고 세트.png"
                         data-default="./assets/images/인스턴트/블루보틀 온더고 세트.png"
                         data-hover="./assets/images/인스턴트/블루보틀 온더고 세트-Hover.jpg"
                         style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                         alt="콜드브루 보틀">
                    <div class="image-caption" style= "bottom: 80px;">
        ...
        <div class="col-auto">
            <div class="card card-1 position-relative"
                ...
                <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
                    <img id="bella-img-5"
                         src="./assets/images/인스턴트/블루보틀 커피 에센셜 세트.png"
                         data-default="./assets/images/인스턴트/블루보틀 커피 에센셜 세트.png"
                         data-hover="./assets/images/인스턴트/블루보틀 커피 에센셜 세트-Hover.jpg"
                         style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                         alt="블루보틀 커피 에센셜 세트"><br>
                    <div class="image-caption" style= "bottom: 80px;">
                        <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">블루보틀 커피 에센셜 세트</h5></div>
                    </div>
                </div>
                <div class="caption-status"
                style="background-color: rgba(242, 242, 242, 0.5);
    ...
    <div class="container">
        ...
        <div class="col-auto" style="margin-right: 63rem;">
            <div class="card card-1 position-relative"
