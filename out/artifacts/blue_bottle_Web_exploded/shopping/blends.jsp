...
<div class="main-banner">
    <!-- 메인 이미지 -->
    <img src="./assets/images/blends_main.jpg" class="img-fluid" alt="메인 이미지">

    <!-- 메인 이미지 위에 배치되는 텍스트 -->
    <div class="banner-text">블렌드 원두</div>
</div>
...
<div class="container">
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <!-- 상단 설명 텍스트 -->
            <div class="hover-caption-top"><br>
                <h5>황금 건포도, 블루베리, 레몬 제스트</h5>
                <h6 class="sub">미디엄 로스트</h6>
              </div>
            <div class="image-wrapper" style="position: relative; height: 100%;">
                <img id="bella-img-4"
                     src="./assets/images/블렌드/쓰리 아프리카스 원두.png"
                     data-default="./assets/images/블렌드/쓰리 아프리카스 원두.png"
                     data-hover="./assets/images/블렌드/쓰리 아프리카스.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="쓰리 아프리카스">
                <div class="image-caption" style= "bottom: 80px;">
                    <div class="caption-top" style="margin-top: 8px;"><p class="blend-label" style="font-size: 14px;">블렌드</p></div>
                    <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">쓰리 아프리카스</h5></div>
                </div>
            </div>
            <div class="caption-status"
            style="background-color: rgba(242, 242, 242, 0.5);
    ...
    <div class="col-auto">
        <div class="card card-1 position-relative"
            ...
            <!-- 상단 설명 텍스트 -->
            <div class="hover-caption-top"><br>
                <h5>크렘 브륄레, 바닐라, 키 라임</h5>
                <h6 class="sub">미디엄 로스트</h6>
              </div>
            <div class="image-wrapper" style="position: relative; height: 100%; margin-left: -1rem;">
                <img id="bella-img-5"
                     src="./assets/images/블렌드/나이트 라이트 디카페인 원두.png"
                     data-default="./assets/images/블렌드/나이트 라이트 디카페인 원두.png"
                     data-hover="./assets/images/블렌드/나이트 라이트 디카페인.jpg"
                     style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; background-color: #f9f9f4;"
                     alt="벨라 도노반"><br>
                <div class="image-caption" style= "bottom: 80px;">
                    <div class="caption-top" style="margin-top: 8px;"><p class="blend-label" style="font-size: 14px;">블렌드</p></div>
                    <div class="caption-bottom" style="margin-bottom: 8px;"><h5 class="coffee-name">나이트 라이트 디카페인</h5></div>
                </div>
            </div>
            <div class="caption-status"
            style="background-color: rgba(242, 242, 242, 0.5);
...
<!-- 3번째 -->
 <div class="container">
    ...
    <div class="col-auto">
        ...
        <div class="col-auto" style="margin-right: 32rem;">
            <div class="card card-1 position-relative"
